...
class OrphanageFormValidator
{
    ...
    static function validateBaseOrphanageParameters($parameters)
    {
        ...
        (isset($parameters[Orphanage::DESCRIPTION_FIELD]) && ValidateHelper::validateTextField($parameters[Orphanage::DESCRIPTION_FIELD], Orphanage::MIN_DESCRIPTION_LENGTH, Orphanage::MAX_DESCRIPTION_LENGTH)) &&
